...
## 更新摘要
**变更内容**   
- 新增侧边栏配额条组件，实时显示各层级配额使用情况
- 增强画布配额投影功能，支持多计费层级（Plus、Pro、Max）的配额管理
- 改进工作区用量显示，提供更直观的配额消耗可视化
- 实现配额耗尽时的升级弹窗机制，引导用户升级到更高计费层级
- 优化配额管理的用户体验和交互流程
...
**更新** 本次更新重点增强了配额管理的用户体验，包括侧边栏配额条、画布配额投影、工作区用量显示和升级弹窗等功能，支持多计费层级的精细化管理。
...
**更新** 本次增强显著提升了用户体验，通过侧边栏配额条、画布配额投影、工作区用量显示和升级弹窗等功能，实现了多计费层级的精细化管理和实时配额监控。
