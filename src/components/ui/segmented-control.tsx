      ...
      {options.map((option) => {
        ...
        return (
          <ControlPressButton
            ...
            className={cn(
              'whitespace-nowrap rounded-md px-3 py-1.5 text-[13px] font-medium transition-[background-color,color,box-shadow] duration-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ds-ring',
              active
