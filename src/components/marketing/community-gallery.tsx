      ...
      >
        ...
        >
          <Image
            ...
            className={cn(
              "duration-slow ease-standard object-cover transition group-hover:scale-[1.015]",
              previewing && "opacity-0"
            )}
          />
          <video
            className={cn(
              "duration-narrative ease-standard pointer-events-none absolute inset-0 size-full object-cover opacity-0 transition-opacity",
          ...
          <span className="duration-narrative ease-standard absolute top-4 right-4 flex size-10 items-center justify-center rounded-full bg-white text-black transition-transform group-hover:scale-110">
