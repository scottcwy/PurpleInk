...
description: >
  ...
  accent, the three-step gray text ladder, MiSans (display/numerals/chrome) + MiSans (body),
...
colors:
  ...
  text-muted: "#50C0C0"
  text-light: "#9A9A9A"
  accent-light: "rgba(80, 176, 240, 0.08)"
  accent-medium: "rgba(80, 176, 240, 0.15)"
  border: "rgba(80, 176, 240, 0.2)"
  card-bg: "rgba(80, 176, 240, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (MiSans body + MiSans chrome) —
  body:    { fontFamily: "MiSans", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "MiSans", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "MiSans", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "MiSans", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (MiSans, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "MiSans", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "MiSans", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "MiSans", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "MiSans", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "MiSans", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "MiSans", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "MiSans", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **MiSans** (display) / **Proxima Nova** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{300, 400, 450, 500, 600, 630, 700}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
...
The voice is two faces in fixed roles: **MiSans** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **MiSans** (body, muted gray, line 1.6). Headlines are near-black;
...
- **MiSans** (display/numerals/chrome) + **MiSans** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (MiSans body 0.85cqw muted; MiSans eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (MiSans `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body MiSans 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line MiSans `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + MiSans label + muted desc + optional
...
blockquote, cite. **Focal** a MiSans `blockquote` near-black under a 15%-opacity cobalt
...
MiSans body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a MiSans `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body MiSans 400 muted, line 1.6.
...
- **Type** — MiSans headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; MiSans body muted line 1.6; ≥1.4cqw floor.
...
- **MiSans + MiSans via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
...
```html
<style>
@font-face{font-family:"MiSans";font-weight:700;font-style:normal;font-display:block;src:url("assets/fonts/MiSans-Bold.woff2") format("woff2");}
@font-face{font-family:"MiSans";font-weight:600;font-style:normal;font-display:block;src:url("assets/fonts/MiSans-SemiBold.woff2") format("woff2");}
@font-face{font-family:"MiSans";font-weight:500;font-style:normal;font-display:block;src:url("assets/fonts/MiSans-Medium.woff2") format("woff2");}
@font-face{font-family:"MiSans";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/MiSans-Regular.woff2") format("woff2");}
@font-face{font-family:"Proxima Nova";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/ProximaNova-Regular.woff2") format("woff2");}
</style>
```
