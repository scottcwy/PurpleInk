...
function helpText(): string {
  return [
    ...
    'purpleink-video run <script.json|script.md> [--global-prompt-file <path>] [--concurrency N] [--narration off|auto|required] [--sfx auto|off]',
    ...
    'purpleink-video submit <input...> [--global-prompt-file <path>] [--sfx auto|off] --json',
